...
#is.integer(5).  #AKO NEMA L NIJE CIJELI BROJ ZA R -- zakomentiran da mogu knittat
...
* `NULL` - nepostojeća vrijednost, doslovno "ništa" #RAZLIČIT OD SQL NULLA -> SQL NULL == NA R
