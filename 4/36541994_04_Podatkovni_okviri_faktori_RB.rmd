...
---
title: "4 Podatkovni okviri i faktori RB"
...
mjesto2 <- read_csv("mjesto.csv")
mjesto3 <- read_csv2("mjestoAlt.csv")
...
# (izraženo u milijunima Kn) - dijelimo sa 1e6
# iznos zaokružite uz pomoć funkcije round ( primjer: round(100.12345, 2) ==>  100.12  )
mjesto$mjesecniPrihod <- round(0.6 * 0.1 * 0.01 * mjesto$prirez * mjesto$prosjPlacaKn * mjesto$brojStanovnika / 1e6, 2)
...
is.ordered(tlak.f3) # ne je li poredan nego je li ordered = TRUE tj. vrijede li operacije vise manje 
