---
title: "7 Korisnički definirane funkcije - RB"
...
ispisiParametre(aa,b,ccc,dddd,e)
...
lapply(l, function(x) {
  ifelse(is.numeric(x), mean(x), 
         ifelse(is.logical(x), sum(x), length(x)))
})
```
...
# razmislite koji će od sljedećih poziva biti uspješan, ->prva i druga
# a koji će izbaciti grešku -> treća
